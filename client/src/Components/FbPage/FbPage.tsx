...
const FbPage:React.FC = () => {
  ...
  return (
   ...
   <div className=' w-screen overflow-hidden bg-black h-[100vh] custom-container '>
    <div className=' flex items-center justify-around mx-auto max-w-[2000px] text-center relative top-[110px] custom-wrapper'>
           ...
           <div className='bg-[whitesmoke] h-[410px] w-[40%] rounded-xl'>
            ...
            <form onSubmit={facebookRegister}>
                ...
                <div>
                  ...
                  <span>Create Your Meta Account</span>
                )}
              </button>
